...
class TreeService:
    ...
    def move_tree_node(self, tree_type: str, request: TreeMoveRequest) -> TreeNode:
        ...
        es_service.update_document(
            request.bk_obj_id, request.bk_inst_id, {"cw__relation": relations}
        )
    ...
    def copy_tree_node(self, tree_type: str, request: TreeCopyRequest) -> TreeNode:
        ...
        new_doc["bk_inst_name"] = (
            request.new_inst_name or f"{existing['bk_inst_name']}_copy"
        )
    ...
    def bind_service_instance(
        self, service_inst_id: int, bk_inst_id: int, bk_obj_id: str
    ) -> Dict:
